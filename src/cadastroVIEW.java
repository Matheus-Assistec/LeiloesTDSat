    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        try {
            ...
            if (nome.isEmpty() || valor.isEmpty()) {
                javax.swing.JOptionPane.showMessageDialog(this, "Preencha o nome e o valor do produto.");
                return;
            }
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Informe um valor numérico válido.");
        } catch (Exception erro) {
            javax.swing.JOptionPane.showMessageDialog(this, "Não foi possível cadastrar o produto.");
        }
